...
function themecore_read_more_link() {
	...
	if ( genesis_a11y() ) {
		return ' . . . <a class="more-link" href="' . get_permalink() . '">Read More<span class="screen-reader-text"> about ' . the_title_attribute( 'echo=0' ) . '</span></a>';
...
function themecore_excerpt_more( $excerpt ) {
	...
	if ( has_excerpt() ) {
		$excerpt_more = ' . . . <a class="more-link" href="' . get_permalink() . '">Read More<span class="screen-reader-text"> about ' . the_title_attribute( 'echo=0' ) . '</span></a>';
	}
